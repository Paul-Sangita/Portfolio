...
const typed = new Typed('.multiple-text', {
    strings: ['Web Developer', 'Frontend Developer', '.Net Developer'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
...
function sendEmail() {
    ...
    Email.send({
        SecureToken: "e2946f3c-16c0-4da5-8108-5be107c570a1",
        To: "700035sangita@gmail.com",
        From: "700035sangita@gmail.com",
...
form.addEventListener("submit", (e) => {
    ...
    if (!fullname.classList.contains("error") && !email.classList.contains("error") &&
        !number.classList.contains("error") && !subject.classList.contains("error") &&
